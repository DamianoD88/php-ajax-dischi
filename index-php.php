...
<div class="row">
    ...
    <?php foreach ($album as $key => $music) { ?>
        <div class=" d-flex  align-items-center my-3">
            <img src="<?php echo $music["poster"]; ?>" alt="" class="img-poster">
            <h3><?php echo $music["title"]; ?></h3>
            <h4><?php echo $music["author"]; ?></h4>
            <h2><?php echo $music["genre"]; ?></h2>
            <div><?php echo $music["year"]; ?></div>
        </div>
